...
public class QuizDbHelperError extends SQLiteOpenHelper {
    ...
    public  void fillQuestionsToDb(){
        ...
        db.execSQL("DROP TABLE IF EXISTS '"+QuestionTable.TABLE_NAME+"'");
        onCreate(db);
        question=new Question("Spot Error in Sentence","If you lend him a book","he will lend it to some one else","and never you will get it bac","No error",3);
